...
We shall use `phy3` to demonstrate performing inference under the CaveDive model. Firstly, it is preferable to use less informative priors for inference when little information is available. 
