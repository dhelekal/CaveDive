...
phy1 <- simulate_expansion_phylo(priors, tip_times, concentration=concentration, collapse_singles=F)
head(phy1)
...
phy2 <- simulate_expansion_phylo(priors, tip_times, concentration=concentration, given=list(n_exp=3, N=100), collapse_singles=F)
...
tip_colours <- c(rep(1,30), rep(2,30), rep(3,40))

phy3 <- simulate_expansion_phylo(priors, tip_times, concentration=concentration, given=list(n_exp=2, tip_colours=tip_colours), collapse_singles=F)
