...
```{r, extract branch modes, eval=eval_events}
...
```{r, fig.cap="Tree Branch Frequency. Left: Marginal. Right: Full posterior", out.width="50%", fig.show="hold", echo=F, eval=eval_events}
...
```{r, fig.cap="Branch Marginals", out.width="50%", fig.show="hold", echo=F, eval=eval_events}
