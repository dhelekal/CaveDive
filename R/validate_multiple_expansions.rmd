...
e_hist <- ggplot(hist_df) + 
          ...
          coord_cartesian(ylim = c(-0.5, 9.5),expand = FALSE) +
...
e_dim_scatter <- e_dim_scatter + theme_bw() + labs(x = "True Number of Expansions", y="Expected Number of Expansions") + scale_x_discrete(c(2:5)) + scale_y_continuous(limits=c(0, 12), breaks=c(0:12)) + coord_cartesian(ylim = c(-0.5, 9.5), xlim = c(1.5,5.5),expand = FALSE)
