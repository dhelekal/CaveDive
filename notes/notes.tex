...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Multistrain+Inhomogenous Case}\label{section:multi}
...
\mathbf{s}\to\mathbf{s}-\mathbf{e_j} \quad \binom{s_j}{2}Neg_j^{-1}(t)+\delta_{s_j, 1}Neg_j(t)^{-1}\sum_{i\neq j}s_iNeg_i(t)
\end{gather}
\subsubsection{Likelihood}
To derive the likelihood of a genealogy given a colouring with non-zero likelihood and growth functions $\mathbf{Neg}:=\{Neg_j(t)\}_{1\leq j\leq M}$, first assume event notation as used in \ref{subsection:likelihood}.\\
Define the set of bifurcation events:
\begin{gather}
\Omega \triangleq \{\omega_j\}_{1\leq j\leq K}\subset S\setminus 1
\end{gather}
...
= \prod_{j=1}^{K}\prod_{i\in S\cap W_j}\left(\mathbbm{1}_Y(i)\frac{\binom{k_i}{2}}{Neg(t_i)}+\mathbbm{1}_I(i)\right)
\exp(-\int_{t_{i-1}}^{t_i}\frac{\binom{k_i}{2}}{Neg(\tau)}d\tau)
\end{gather}
The second term:
\begin{gather}
\prod_{j=1}^{K}\mathcal{L}(\mathbf{g}\cap \omega_j \mid \mathbf{Neg})
= \prod_{i\in\Omega}\left(\frac{k_i}{Neg(t_i)}\right)
\exp(-\int_{t_{i-1}}^{t_i}\frac{k_i}{Neg(\tau)}d\tau)
\end{gather}
...
Additionally, one will have to consider a suitable prior for bifurcation points. This will likely have to be computed as a function of leaf colouring, possiblt integrating covariate information (geographic location?).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
