...
\end{gather}
In our inference scenario we will assume the following. There exists a neutral population with constant population size. This can be interpreted as the parent populatio{}n of the pathogen being at steady state. All diverging populations follow the growth function \ref{eq:loggrowth}.
\subsection{Priors}
